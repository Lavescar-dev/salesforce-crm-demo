...
import { getAccountNames, updateInvoice } from "~/data/mock-data";
import { useLocale } from "~/data/i18n";

const invoiceEditCopy = {
  en: {
    notFound: "Invoice not found",
    back: "Back to Invoices",
    title: "Edit Invoice",
    intro: "Update invoice information",
  ...
  tr: {
    ...
    intro: "Fatura bilgilerini güncelle",
...
export default component$(() => {
  ...
  const copy = invoiceEditCopy[locale.value];
  ...
  useVisibleTask$(() => {
    document.title =
      locale.value === "tr" ? "Faturayı Düzenle" : "Edit Invoice";
  });
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 sm:gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange$={(event) => {
                    const nextStatus = (event.target as HTMLSelectElement)
              ...
              <div>
                ...
                <input
                  id="paidDate"
                  type="date"
                  value={formData.status === "Paid" ? formData.paidDate : ""}
                  onInput$={(event) => {
                    formData.paidDate = (
                      event.target as HTMLInputElement
                    ).value;
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Edit an invoice in the Qwik CRM demo.",
    },
  ],
};
