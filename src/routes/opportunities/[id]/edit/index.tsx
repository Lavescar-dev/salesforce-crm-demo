...
import { getAccountNames, updateOpportunity } from "~/data/mock-data";
import { useLocale } from "~/data/i18n";

const opportunityEditCopy = {
  en: {
    notFound: "Opportunity not found",
    back: "Back to Opportunities",
    title: "Edit Opportunity",
    intro: "Update deal information",
  ...
  tr: {
    ...
    intro: "Fırsat bilgilerini güncelle",
...
export default component$(() => {
  ...
  const copy = opportunityEditCopy[locale.value];
  ...
  const formData = useStore({
    ...
    isHighValue: opportunity?.isHighValue ?? false,
  });

  // eslint-disable-next-line qwik/no-use-visible-task
  useVisibleTask$(() => {
    document.title =
      locale.value === "tr" ? "Fırsatı Düzenle" : "Edit Opportunity";
  });
  ...
  return (
    <div class="space-y-4 p-4 sm:space-y-6 sm:p-6">
      ...
      <form
        ...
        onSubmit$={() => {
          updateOpportunity(demoData, id, formData);
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Edit an opportunity in the Qwik CRM demo.",
    },
  ],
};
