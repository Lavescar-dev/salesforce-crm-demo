...
import { getAccountNames, updateQuote } from "~/data/mock-data";
...
const quoteEditCopy = {
  en: {
    ...
    back: "Back to Quotes",
    title: "Edit Quote",
    intro: "Update quote information",
  ...
  tr: {
    ...
    intro: "Teklif bilgilerini güncelle",
...
export default component$(() => {
  ...
  const copy = quoteEditCopy[locale.value];
  ...
  useVisibleTask$(() => {
    document.title = locale.value === "tr" ? "Teklifi Düzenle" : "Edit Quote";
  });
  ...
  return (
    <div class="space-y-4 p-4 sm:space-y-6 sm:p-6">
      ...
      <form
        ...
        onSubmit$={() => {
          updateQuote(demoData, id, formData);
          navigate(`/quotes/${id}`);
        }}
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Edit a quote in the Qwik CRM demo.",
    },
  ],
};
