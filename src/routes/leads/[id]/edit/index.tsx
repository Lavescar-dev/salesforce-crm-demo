...
import { updateLead } from "~/data/mock-data";
...
const leadFormCopy = {
  ...
  tr: {
    ...
    title: "Adayı Düzenle",
    intro: "Aday bilgilerini güncelleyin",
...
export default component$(() => {
  ...
  useVisibleTask$(() => {
    document.title = locale.value === "tr" ? "Adayı Düzenle" : "Edit Lead";
  });
  ...
  return (
    <div class="space-y-4 p-4 sm:space-y-6 sm:p-6">
      ...
      <form
        ...
        onSubmit$={() => {
          updateLead(demoData, id, formData);
          navigate(`/leads/${id}`);
        }}
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Edit a lead in the Qwik CRM demo.",
    },
  ],
};
