...
import { addAccount, type Account } from "~/data/mock-data";
import { useLocale } from "~/data/i18n";

const accountFormCopy = {
  en: {
    title: "New Account",
    intro: "Create a new customer account",
  ...
  tr: {
    title: "Yeni Hesap",
    intro: "Yeni bir müşteri hesabı oluşturun",
...
export default component$(() => {
  ...
  const copy = accountFormCopy[locale.value];
  const navigate = useNavigate();
  const formData = useStore({
    name: "",
    industry: "",
    type: "Mid-Market" as Account["type"],
    revenue: 0,
    employees: 0,
  ...
  useVisibleTask$(() => {
    document.title = locale.value === "tr" ? "Yeni Hesap" : "New Account";
  });
  ...
  return (
    <div class="space-y-4 p-4 sm:space-y-6 sm:p-6">
      ...
      <form
        ...
        onSubmit$={() => {
          const createdAccount = addAccount(demoData, formData);
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Create a new account in the Qwik CRM demo.",
    },
  ],
};
